...
dag = DAG('packagist_static_versions_1', default_args=default_args, schedule_interval=None)
# periodically run the dag
# dag = DAG('tutorial', default_args=default_args, schedule_interval=timedelta(days=1))

# load dep_tree for packages, relative to AIRFLOW_HOME
packagist_dep_path = "./dags/packagist.with_stats.popular.versions.dep_graph_1.pickle"
