...
dag = DAG('rubygems_static_versions_4', default_args=default_args, schedule_interval=None)
# periodically run the dag
# dag = DAG('tutorial', default_args=default_args, schedule_interval=timedelta(days=1))

# load dep_tree for packages, relative to AIRFLOW_HOME
rubygems_dep_path = "./dags/rubygems.with_stats.popular.versions.dep_graph_4.pickle"
