...
require_once(__DIR__ . "/../php/GPBMetadata/Ast.php");
require_once(__DIR__ . "/../php/GPBMetadata/Info.php");
require_once(__DIR__ . "/../php/GPBMetadata/Module.php");
require_once(__DIR__ . "/../php/Proto/AstLookupConfig.php");
require_once(__DIR__ . "/../php/Proto/ModuleStatic.php");

use Proto\AstLookupConfig;
use Proto\ModuleStatic;
...
class MyOutputs
{
    ...
    {
        $astConfig = new AstLookupConfig();
        $moduleStatic = new ModuleStatic();
        return $this->results;
    }
